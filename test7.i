...
[Materials]
  ...
  # FIXED: f_name changed to mu_param to match what interface_mobility requests
  [./mu_param] 
    type = ParsedMaterial
    f_name = mu_param
    material_property_names = 'length_scale energy_scale sigma delta'
  ...
  # FIXED: f_name changed to Fch1, Fch2, Fch3 to match what DerivativeSumMaterial requests
  [./fch1]
  ...
  # FIXED: sum_materials now correctly references the f_name (Fch1, Fch2, Fch3)
  [./F_1]
